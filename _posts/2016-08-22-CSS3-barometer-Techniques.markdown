...
categories: CSS
---
####虽然在国内使用 CSS3 距离还是有些远,但是我们也要学习这些新技术,今天为大家分享一些很酷的 CSS3 特效案例,用 CSS3 的新特性制作7个很酷的晴雨表动画，有些带教程,很值得学习的。
...
首先，先让container这个垂直和水平居中，其次，7个晴雨表宽度为了保持一致，先计算100%/7 =14.285714...；
